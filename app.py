...
# Schedule the refresh_data function to run every 5 minutes
scheduler = BackgroundScheduler()
scheduler.add_job(refresh_data, 'interval', minutes=5)  # Adjust the interval as needed
scheduler.start()
...
def home():
    ...
    if not cached_signals:
        print("⚠️ No cached data found. Fetching data for the first time...")
        refresh_data()  # Fetch data initially if the cache is empty
    ...
    """
    return render_template_string(html_template, signals=cached_signals)
